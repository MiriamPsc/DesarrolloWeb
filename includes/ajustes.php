...
<html lang="es">
    <head>
        ...
        <title>Perfil Principal | Institución Jeffersonian</title>
                    ...
                    <div class="row">
                        <div class="col-md-3 ">
                            ...
                            <div class="list-group ">
                                ...
                                <a href="#" class="list-group-item list-group-item-action text-dark bg-warning" style="--bs-bg-opacity: .5;">Ajustes</a><br>
                                        ...
                                        <div class="col-md-12">
                                            <form action="actualizar.php" method="POST">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-8">
                                                        <input id="nombre" name="nombre" placeholder="Nombres" class="form-control here" type="text">
                                                    </div>
                                                </div><br>
                                                <div class="form-group row">
                                                    <label for="lastname" class="col-4 col-form-label">Apellido Paterno</label> 
                                                    <div class="col-8">
                                                        <input id="apellidoPaterno" name="apellidoPaterno" placeholder="Apellido Paterno" class="form-control here" type="text">
                                                    </div>
                                                </div><br>
                                                <div class="form-group row">
                                                    <label for="lastname" class="col-4 col-form-label">Apellido Materno</label> 
                                                    <div class="col-8">
                                                        <input id="apellidoMaterno" name="apellidoMaterno" placeholder="Apellido Materno" class="form-control here" type="text">
                                                    </div>
                                                </div><br>
                                                <div class="form-group row">
                                                    <label for="email" class="col-4 col-form-label">Correo Electrónico</label> 
                                                    <div class="col-8">
                                                        <input id="email" name="email" placeholder="Correo Electrónico" class="form-control here" required="required" type="text">
                                                    </div>
                                                </div><br>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    <div class="offset-4 col-8">
                                                        <button name="submit" type="submit" href="perfil.php" class="btn btn-warning">Actualizar información</button>
                                                    </div>
                                                </div> 
                                            </form>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <hr>
                                            <label for="username" class="col-4 col-form-label">Esta acción desactivará tu cuenta.</label> 
                                            <button name="submit" type="submit" href="inicio.php" class="btn btn-danger">Desactivar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
